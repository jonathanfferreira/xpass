...
const ProductCard: React.FC<ProductCardProps> = ({ product, onAddToCart }) => {
  return (
    <div className="group relative flex flex-col bg-onyx-900 rounded-2xl border border-white/5 overflow-hidden transition-all duration-300 hover:border-brand-500/50 hover:shadow-[0_0_20px_rgba(255,82,0,0.15)]">
      ...
      <div className="relative aspect-square overflow-hidden bg-onyx-800">
        ...
        <button 
          ...
          className="absolute bottom-2 right-2 w-8 h-8 bg-brand-500 rounded-lg flex items-center justify-center text-black font-bold translate-y-10 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 shadow-lg cursor-pointer"
        >
